...
#         print(f"outputerrorterm {output_error_term.shape}")
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(self.weights_hidden_to_output, error)
        hidden_error_term = hidden_error*hidden_outputs*(1-hidden_outputs) # grad?
...
#         final_outputs = None # signals from final output layer
        ...
        # it is stupid to write this function twice (WET) ... you should teach
        # students to write it once (DRY)
